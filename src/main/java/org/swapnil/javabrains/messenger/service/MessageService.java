...
import org.swapnil.javabrains.messenger.exception.DataNotFoundException;
...
public class MessageService {
	...
	public MessageService() {
		...
		messages.put(1L, new Message(1, "Hello Java Brains", "Swapnil"));
		messages.put(2L, new Message(2, "FissionSoft LLC", "USA"));
	}
